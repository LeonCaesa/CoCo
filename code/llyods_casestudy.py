...
maturity = pd.to_datetime('2019-06-02')
T = np.array((maturity - data.index).days.astype(int)/365)
...
def optimize_convertcoco(param, w_bar = None, r=None, q=None, K=None, T=None, c=None, Jbar=None, M=None, coco_price=None,  # data
...
K = 77.5158 # To confirm CoCo notational
c = 0.15 # To confirm coupon rates?
M = 20 # To confirm coupon numbers?
...
res = minimize(optimize_convertcoco, init, args=(wbar, r, q, K, T, c, Jbar, M, coco_price,  # data
